...
export let QueryObject = paramBuilder('QueryObject')('QueryObject');
/**
...
export let FileUpload = paramBuilder('FileUpload')('FileUpload');

export let FormUpload = paramBuilder('FormUpload')('FormUpload');

export let MixedMultipart = function (fileProperty: string) {
    return function (target: RESTClient, propertyKey: string | symbol, parameterIndex: number) {
...
function methodBuilder(method: string) {
    return function (url: string) {
        return function (target: RESTClient, propertyKey: string, descriptor: any) {
            ...
            const formUpload = target[`${propertyKey}_FormUpload_parameters`];
            ...
            descriptor.value = function (...args: any[]) {
                    ...
                    pQueryObject
                        .forEach(p => {
                            ...
                            if (value instanceof Object) {
                                ...
                                throw new Error('Parameter annotated @QueryObject must be Object!');
                            }
                        });
                }
                ...
                if (pHeader && pHeader.headers) {
                    ...
                    const customeHeader = pHeader.headers;
                    // tslint:disable-next-line: forin
                    for (const k in customeHeader) {
                ...
                if (formUpload) {
                    body = new FormData();
                    const data = args[formUpload[0].parameterIndex];
                    body.append(data);
                    // for(let k in data){
                    // body.append(data);
                    // }
...
export let ErrorHandler = function (errorMessageKeyPrefix: string) {
    return function (target: RESTClient, propertyKey: string, descriptor: any) {
...
export let SkipErrorHandler = function (...statusCodes: number[]) {
    return function (target: RESTClient, propertyKey: string, descriptor: any) {
...
export let DisableScoping = function () {
    return function (target: RESTClient, propertyKey: string, descriptor: any) {
...
export let ResponseType = function (responseType: string) {
    return function (target: RESTClient, propertyKey: string, descriptor: any) {
